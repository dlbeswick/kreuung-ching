// NOTE: this file is a hack to get around a current issue with Cordova's 'plugin add' command on my system.
// Target location is app/node_modules/cordova-lib/src/cordova/plugin/util.js
/**
...
function info (plugin) {
  ...
  // check if npm is installed
    ...
    .then(function () {
      const args = ['-c', `npm ${viewArgs.join(' ')} | cat`]
          return execa('bash', args)
                .then(({ stdout: info }) => {
